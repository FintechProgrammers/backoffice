                    ...
                    <div class="col-lg-6">
                        ...
                        <div class="mb-3">
                            ...
                            <div class="input-group ">
                                ...
                                <input type="number" min="0" step="any" name="ambassador_fee" value="{{ !empty(systemSettings()->ambassador_fee) ? systemSettings()->ambassador_fee : 0 }}"
                ...
                <div class="row">
                    ...
                    <div class="col-lg-6 mb-3">
                        ...
                        <div class="input-group">
                            ...
                            <input type="number" min="1" name="bv_equivalent" class="form-control" id="basic-url" value="{{ !empty(systemSettings()->bv_equivalent) ? systemSettings()->bv_equivalent : 0 }}"
