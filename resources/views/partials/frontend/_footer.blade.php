 <div class="footer black">
         ...
         <div id="w-node-_2d219e0c-505e-ea1e-47e6-fba1acda1aff-acda1af1" class="footer-3-columns-grid">
             <div class="align-left-and-vertical">
                 ...
                 <div class="black-link-wrap margins">
                     <a href="{{ route('home') }}" class="black-footer-link">Home</a>
                     <div class="black-underline"></div>
                 </div>
                 <div class="black-link-wrap margins">
                     <a href="{{ route('owntheFuture') }}" class="black-footer-link">OwnTheFuture</a>
                     <div class="black-underline"></div>
                 </div>

                 <div class="black-link-wrap margins">
                     <a href="{{ route('service') }}" class="black-footer-link">Services</a>
                     <div class="black-underline"></div>
                 </div>

                 <div class="black-link-wrap margins">
                     <a href="{{ route('contact') }}" class="black-footer-link">Contact</a>
                     <div class="black-underline"></div>
                 </div>
             </div>
             <div class="align-left-and-vertical">
     ...
     <div class="footer-bottom">
         <div class="footer-credits">
             © 2022 DELTA DIGITAL LLC. ALL RIGHTS RESERVED.
         </div>
     </div>
 </div>
